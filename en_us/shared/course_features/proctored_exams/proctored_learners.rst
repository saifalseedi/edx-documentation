...
.. only:: Partners
  ...
  * Explain what proctored exams are, and provide learners with links to
    `Taking Timed and Proctored Exams`_ in the edX Learner Help Center.
  * Communicate the rules for proctored exams, including the `Proctored exam
    rules and requirements`_ article in the edX Learner Help Center. as well as
...
.. only:: Partners
 ...
 Timed and Proctored Exams`_ in the edX Learner Help Center.
